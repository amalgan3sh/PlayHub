    ...
    <nav class="main-header">
      ...
      <div id="menu">
        ...
        <ul class="text-center text-capitalize nav-agile" data-aos="zoom-in-up">
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/adminHome" class="active">home</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/adminManageTurf">Manage Proprietor</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/admnViewBookings">Bookings</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/adminViewFeedback">Feedback</a>
          </li>
