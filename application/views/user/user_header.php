    ...
    <nav class="main-header">
      ...
      <div id="menu">
        ...
        <ul class="text-center text-capitalize nav-agile" data-aos="zoom-in-up">
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/userHome" class="active">home</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/userViewBookings">Bookings</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/userViewTurf">Book Now</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/userChallenge">Challenge</a>
          </li>
          <li>
            <a href="<?php echo site_url(); ?>/Onlinecontroller/userGiveFeedback">Feedback</a>
          </li>
